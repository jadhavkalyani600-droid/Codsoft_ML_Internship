...
plt.tight_layout()
plt.show()
# --- step 5: creating csv file of result ---
# Let's save the test data predictions into a file
results_df = pd.DataFrame({
    'Actual_Value': y_test.values,
    'Model_Prediction': y_pred_rf  # We are using the Random Forest results because they are more accurate
})

results_df.to_csv('CHURN_FINAL_REPORT.csv', index=False)

print("\n" + "="*45)
print("✅ SUCCESS! 'CHURN_FINAL_REPORT.csv' is created.")
print("check this file in your folder.")
print("="*45)